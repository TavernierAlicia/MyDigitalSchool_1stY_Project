...
<head>
    ...
    <?php include_once('core/events/modifier.php'); ?>
</head>
<body><!-- HEADER-->
...
<div id="wrapper-content"><!-- PAGE WRAPPER-->
                ...
                <div class="section section-padding contact-main">
                    <div class="container">
                        <div class="contact-main-wrapper">
                            <div class="group-title-index"><h4 class="top-title">Evenement</h4>
                                <h2 class="center-title">modifier un Evenement</h2>
                                <div class="bottom-title"><i class="bottom-icon icon-a-01-01"></i></div>
                            </div>
                            <form class="bg-w-form contact-form" action="core/events/modifier.php" method="post" id="event-modifier" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label form-label">TITRE <span class="highlight">*</span></label>
                                            <input type="text" placeholder="" class="form-control form-input" name="titre" value="<?php echo $event['titre']; ?>" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="control-label form-label">DATE DEBUT ET FIN</label>
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                <input type='datetime-local'
                                                       class="form-control form-input" name="debut" id="debut"
                                                       value="<?php echo date("Y-m-d\TH:i", strtotime($event['date_deb'])); ?>"
                                                       required/>
                                            </div>
                                            <div class="col-md-6">
                                                <input type='datetime-local'  class="form-control form-input"
                                                       name="fin" id="fin"
                                                       value="<?php echo date("Y-m-d\TH:i", strtotime($event['date_fin'])); ?>"
                                                       required/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-12">
                                            <div class="contact-question form-group">
                                                ...
                                                <textarea class="form-control form-input" name="description"
                                                          required><?php echo $event['description']; ?></textarea>

                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label form-label">LIEUX</label>
                                                    <input type="text" placeholder=""
                                                           class="form-control form-input" name="lieu"
                                                           value="<?php echo $event['lieux']; ?>" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-file-container">
                                                    <input class="input-file" id="my-file" type="file" name="photo" multiple>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="input-file-container">
                                                <img src="uploads/events/<?php echo $event['photo']; ?>" style="width: 100%;margin-top: -50px;">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="contact-submit">
                                        <input type="hidden" name="id" value="<?php echo $event['id'];?>" >
                                        <input type="hidden" name="path" value="<?php echo $event['photo'];?>" >
                                        <button type="submit" class="btn btn-contact btn-green" name="modify">
                                            <span>Modifier Evenement</span>
                                        </button>
                                    </div>
                            </form>
                        </div>
    ...
    <script src="assets/js/validation/event.js"></script>
</body>
</html>