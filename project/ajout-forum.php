                    ...
                    <div class="container">
                        <div class="contact-main-wrapper">
                            <div class="group-title-index"><h4 class="top-title">Forum</h4>
                                <h2 class="center-title">ajout neveau article</h2>
                                <div class="bottom-title"><i class="bottom-icon icon-a-01-01"></i></div>
                            </div>
                            <form class="bg-w-form contact-form" action="core/forum/forum.php" method="post" id="forum-ajouter" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
