                    ...
                    <div class="container">
                        <div class="contact-main-wrapper">
                            <div class="group-title-index"><h4 class="top-title">Cours</h4>
                                <h2 class="center-title">ajout des cours</h2>
                                <div class="bottom-title"><i class="bottom-icon icon-a-01-01"></i></div>
                            </div>
                            <form class="bg-w-form contact-form" action="core/cours/cours.php" method="post" id="cours-ajouter" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label form-label">TITRE <span class="highlight">*</span></label>
                                            <input type="text" placeholder="" class="form-control form-input" name="titre" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-file-container">
                                                <input class="input-file" id="my-file" type="file" name="cours[]" multiple accept=".pdf,.doc,.docx,.ppt,.pptx" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="contact-question form-group">
                                            ...
                                            <textarea class="form-control form-input" name="description" required></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label form-label">CLASSE</label>
                                ...
                                <div class="contact-submit">
                                    <button type="submit" class="btn btn-contact btn-green" name="ajout"><span>Ajout Cours</span>
                                    </button>
                                </div>
                            </form>
                        </div>
...
<script src="assets/js/validation/cours.js.js"></script>
