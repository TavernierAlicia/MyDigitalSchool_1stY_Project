                    ...
                    <div class="container">
                        <div class="page-title-wrapper"><!--.page-title-content--><h2 class="captions">Cours</h2>
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><a href="ajout-cours.php">Ajout</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="contact-main-wrapper">
                            <div class="group-title-index"><h4 class="top-title">Evenement</h4>
                                <h2 class="center-title">ajout un Evenement</h2>
                                <div class="bottom-title"><i class="bottom-icon icon-a-01-01"></i></div>
                            </div>
                            <form class="bg-w-form contact-form" id="event-ajouter" action="core/events/events.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label form-label">TITRE <span class="highlight">*</span></label>
                                            <input type="text" placeholder="" class="form-control form-input"  name="titre" />
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                <input type='datetime-local' format="dd/MM/yyyy h:i"  class="form-control form-input" name="debut" id="debut" />
                                            </div>
                                            <div class="col-md-6">
                                                <input type='datetime-local' format="dd/MM/yyyy h:i"  class="form-control form-input" name="fin" id="fin"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="contact-question form-group">
                                            ...
                                            <textarea class="form-control form-input" name="description" ></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="" class="form-control form-input" name="lieu" />
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-file-container">
                                                    <input class="input-file" id="my-file" type="file" name="cours[]" accept=".png,.jpeg,.jpg,.svg" multiple required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="contact-submit">
                                    <button type="submit" class="btn btn-contact btn-green" name="ajout">
                                        <span>Ajout Evenement</span>
                                    </button>
                                </div>
                            </form>
                        </div>
